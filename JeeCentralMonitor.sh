...
let "TCreturn = (${args[23]} << 8) + ${args[22]}"
...
if [ -f /tmp/BME280.temp ] ;
	then
		...
		post "http://api.thingspeak.com/update?key=O64IA4X1ZIVU9DWN&field1=$bmeTemp&field2=$setBack&field3=$BTarget&field4=$misMatch&field5=$ColdFeed&field6=$BoilerFeed&field7=$CHreturn&field8=$TCreturn" # >> /etc/heyu/JeeCentral1.post
	else
		post "http://api.thingspeak.com/update?key=O64IA4X1ZIVU9DWN&field2=$setBack&field3=$BTarget&field4=$misMatch&field5=$ColdFeed&field6=$BoilerFeed&field7=$CHreturn&field8=$TCreturn" # >> /etc/heyu/JeeCentral1.post
fi
