...
if [[ "${args[2]}" == "Busy" ]];
	...
	post  "http://api.thingspeak.com/update?key=BTLO8PRRC6ZY0MJ1&field7=$noiseFloor&field8=$noiseFloor"
else
	post  "http://api.thingspeak.com/update?key=BTLO8PRRC6ZY0MJ1&field7=$noiseFloor"
fi
